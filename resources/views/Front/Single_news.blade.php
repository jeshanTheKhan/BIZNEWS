...
<head>
    <meta charset="utf-8">
    <title>BizNews - Single News Details</title>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="text-truncate"><a class="text-secondary text-uppercase font-weight-semi-bold" href="">
                                @if(Session::get('lang') == 'bangla')
                                    {{ Str::words($trending->bangla_title, 10, '...') }}
                                @else 
                                    {{ Str::words($trending->english_title, 10, '...') }}
                                @endif 
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="{{asset('storage/back/media/news/'.$result->image)}}" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                ...
                                <a class="text-body" href="">{{$result->date}}</a>
                            </div>
