    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
        ...
        <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
            <div class="navbar-nav mr-auto py-0">
                <a href="{{route('welcome')}}" class="nav-item nav-link active">
                    @if(Session::get('lang') == 'bangla')
                    হোম
                    @else 
                    Home 
...
<div class="container-fluid bg-dark pt-5 px-sm-3 px-md-5 mt-5">
    <div class="row py-4">
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <p class="font-weight-medium"><i class="fa fa-map-marker-alt mr-2"></i>{{$admin->address}}</p>
            <p class="font-weight-medium"><i class="fa fa-phone-alt mr-2"></i>+88{{$admin->number}}</p>
