                        ...
                        <form id="formAccountSettings" action="{{route('profile.update')}}" method="POST">
                          ...
                          <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="address" value="{{Auth::user()->twitter }}" name="twitter" placeholder="Address" />
                              </div>
                              <div class="mb-3 col-md-6">
                                <label for="address" class="form-label">Facebook</label>
                                <input type="text" class="form-control" id="address" value="{{Auth::user()->facebook }}" name="facebook" placeholder="Address" />
                              </div>
                              <div class="mb-3 col-md-6">
                                <label for="address" class="form-label">Linkdln</label>
                                <input type="text" class="form-control" id="address" value="{{Auth::user()->linkedln }}" name="linkdln" placeholder="Address" />
                              </div>
                              <div class="mb-3 col-md-6">
                                <label for="address" class="form-label">Instagram</label>
                                <input type="text" class="form-control" id="address" value="{{Auth::user()->instagram }}" name="instagram" placeholder="Address" />
                              </div>
                              <div class="mb-3 col-md-6">
                                <label for="address" class="form-label">Youtube</label>
                                <input type="text" class="form-control" id="address" value="{{Auth::user()->youtube }}" name="youtube" placeholder="Address" />
                              </div>
                          </div>
                          <div class="mt-2">
