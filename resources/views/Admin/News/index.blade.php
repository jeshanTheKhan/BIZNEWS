    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br>
                    <form id="demo-form2" data-parsley-validate="" method="POST" action="{{route('save.news')}}" class="form-horizontal form-label-left" novalidate="" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <textarea class="form-control" id="englishbody" placeholder="Enter the Description" name="englishbody"></textarea>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <textarea class="form-control" id="banglabody" placeholder="Enter the Description" name="banglabody"></textarea>
                            </div>
