 ...
 <div class="right_col" role="main">
    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br>
                <form id="demo-form2" data-parsley-validate="" method="POST" action="{{route('update.add')}}" class="form-horizontal form-label-left" novalidate="" enctype="multipart/form-data">
                    @csrf

                    
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Link
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="first-name" name="link" value="{{$result->add_link}}" placeholder="Link" class="form-control ">
                        </div>
                    </div>
                    <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="basic-icon-default-company">Main Thumbnail</label>
                        <div class="col-sm-10">
                            <img id="studentPhoto" src="{{asset('storage/back/media/add/'.$result->add_image)}}" style="width: 20%;height:auto;" alt="Avatar" title="Change the avatar">
                          <div class="col-md-7 col-sm-6">
                            <input class="form-control" type="file" name="main_thumbnail" id="formFile"  onchange="studentphoto(this);" id="photo" accept="image/*">
                          </div>
                        </div>
                    </div>
                    <input type="hidden" name="c_id" value="{{$result->add_id}}">
