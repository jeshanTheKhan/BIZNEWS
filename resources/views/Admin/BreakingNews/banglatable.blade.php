              ...
              <tbody>    
                ...
                <tr role="row" class="odd">
                  ...
                  @endif
                    ...
                    <td>
                        <a href="{{route('edit.bangla.breakingnews',$result->breakingnews_id)}}"><i class="fa fa-pencil"></i></a>
                        <a href="{{route('del.breakingnews',$result->breakingnews_id)}}" style="margin-left: 10px;"><i class="fa fa-trash"></i></a>
