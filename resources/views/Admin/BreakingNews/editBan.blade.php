 ...
 <div class="right_col" role="main">
    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br>
                <form id="demo-form2" data-parsley-validate="" method="POST" action="{{route('update.bangla.breakingnews')}}" class="form-horizontal form-label-left" novalidate="">
                    @csrf
                    ...
                    <div class="item form-group">
                        <div class="col-md-6 col-sm-6 offset-md-3">
                            <a href="{{route('bangla.breakingnews')}}" class="btn btn-primary" type="button">Cancel</a>
